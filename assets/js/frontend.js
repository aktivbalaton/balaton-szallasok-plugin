...
jQuery(document).ready(function ($) {
    ...
    function buildModalHTML(d) {
        ...
        if (d.kepek && d.kepek.length > 0) {
            ...
            if (d.kepek.length > 1) {
                kepekHTML += '<button class="bsza-lb-arrow bsza-lb-prev" id="bsza-lb-prev" aria-label="Előző kép"><img class="bsza-arrow-ikon" src="' + szallasokAjax.pluginUrl + 'assets/img/arrow-left.svg" alt="" /></button>';
                kepekHTML += '<button class="bsza-lb-arrow bsza-lb-next" id="bsza-lb-next" aria-label="Következő kép"><img class="bsza-arrow-ikon" src="' + szallasokAjax.pluginUrl + 'assets/img/arrow-right.svg" alt="" /></button>';
            }
    ...
    function openLightboxFullscreen(index) {
        ...
        var $fs = $('<div id="bsza-lightbox-fs">' +
            ...
            '<button class="bsza-fs-arrow" id="bsza-fs-prev" aria-label="Előző kép"><img class="bsza-arrow-ikon" src="' + szallasokAjax.pluginUrl + 'assets/img/arrow-left.svg" alt="" /></button>' +
            '<img id="bsza-fs-img" src="' + currentImages[index].url + '" alt="" />' +
            '<button class="bsza-fs-arrow" id="bsza-fs-next" aria-label="Következő kép"><img class="bsza-arrow-ikon" src="' + szallasokAjax.pluginUrl + 'assets/img/arrow-right.svg" alt="" /></button>' +

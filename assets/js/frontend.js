...
jQuery(document).ready(function ($) {
    ...
    function buildModalHTML(d) {
        ...
        if (d.kepek && d.kepek.length > 0) {
            ...
            if (d.kepek.length > 1) {
                kepekHTML += '<button class="bsza-lb-arrow bsza-lb-prev" id="bsza-lb-prev" aria-label="Előző kép"><span class="bsza-arrow-ikon" aria-hidden="true"></span></button>';
                kepekHTML += '<button class="bsza-lb-arrow bsza-lb-next" id="bsza-lb-next" aria-label="Következő kép"><span class="bsza-arrow-ikon" aria-hidden="true"></span></button>';
            }
    ...
    function openLightboxFullscreen(index) {
        ...
        var $fs = $('<div id="bsza-lightbox-fs">' +
            ...
            '<button class="bsza-fs-arrow" id="bsza-fs-prev" aria-label="Előző kép"><span class="bsza-arrow-ikon" aria-hidden="true"></span></button>' +
            '<img id="bsza-fs-img" src="' + currentImages[index].url + '" alt="" />' +
            '<button class="bsza-fs-arrow" id="bsza-fs-next" aria-label="Következő kép"><span class="bsza-arrow-ikon" aria-hidden="true"></span></button>' +

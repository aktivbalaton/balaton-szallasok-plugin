...
jQuery(document).ready(function ($) {
    ...
    function buildModalHTML(d) {
        ...
        if (d.kepek && d.kepek.length > 0) {
            ...
            if (d.kepek.length > 1) {
                kepekHTML += '<button class="bsza-lb-arrow bsza-lb-prev" id="bsza-lb-prev" aria-label="Előző kép"><i class="fas fa-chevron-left bsza-arrow-ikon" style="color:#E8943A !important"></i></button>';
                kepekHTML += '<button class="bsza-lb-arrow bsza-lb-next" id="bsza-lb-next" aria-label="Következő kép"><i class="fas fa-chevron-right bsza-arrow-ikon" style="color:#E8943A !important"></i></button>';
            }
    ...
    function openLightboxFullscreen(index) {
        ...
        var $fs = $('<div id="bsza-lightbox-fs">' +
            ...
            '<button class="bsza-fs-arrow" id="bsza-fs-prev" aria-label="Előző kép"><i class="fas fa-chevron-left bsza-arrow-ikon" style="color:#E8943A !important"></i></button>' +
            '<img id="bsza-fs-img" src="' + currentImages[index].url + '" alt="" />' +
            '<button class="bsza-fs-arrow" id="bsza-fs-next" aria-label="Következő kép"><i class="fas fa-chevron-right bsza-arrow-ikon" style="color:#E8943A !important"></i></button>' +
